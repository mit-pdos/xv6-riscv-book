...
give itself
access to various hardware resources at predictable virtual addresses.
...
This direct mapping helps kernel code that needs to read or write
physical memory, for example when \lstinline{fork}
or \lstinline{exec} allocates and initializes user memory:
the kernel can simply use a physical address
