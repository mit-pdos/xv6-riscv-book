...
A potential downside of the three-level structure compared to a single
level is that the CPU must perform a lookup in three page
directories to determine the physical address for a virtual address.
To avoid this cost, a RISC-V CPU caches page table entries in a
