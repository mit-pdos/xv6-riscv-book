...
process with an abstract version of a page table (see Figure~\ref{fig:riscv_pagetable}
for a fuller story).
A page table
...
is not present, the paging hardware raises an \indextext{page-fault exception}, leaving it up
