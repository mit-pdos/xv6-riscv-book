...
Since the page directories are in physical memory, the kernel can map
the page directories into its page table.  Once they are mapped, the
kernel can program the content of a PTE in a page directory by
executing a store instruction to the address of the PTE in memory.
