...
implementing simple on-disk data structures to represent directories
...
disk blocks.  The rest of this chapter focusses
on the upper layers while Chapter~\ref{CH:LOG} discusses the lower layers.
