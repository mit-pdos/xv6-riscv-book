...
problem, since the child doesn't start executing before the parent has
completely finished writing. It is a potential memory ordering problem
...
up, the memory barriers in the {\tt acquire} and {\tt release}
functions ensure that the child's CPU sees the parent's writes.
