...
\mfk{Should we straighten out our terminology?  We use CPU, core, and
  processor interchangeably; maybe here the place to explain this. Or
  perhaps cleanup our terms?}
...
Xv6 runs on a RISC-V processor with 39 bits for virtual addresses,
...
the process's \indextext{trap frame}
...
\lstinline{proc}
structure.  The trap frame mentioned above is \indexcode{p->tf}.
