...
\lstinline{__atomic_store_n(addr, value, ...)}
that stores the value to the address in a single
...
\lstinline{amoswap} instruction generated for the atomic call.
...
before the \lstinline{release()}'s \lstinline{amoswap}
instruction completes. This includes
