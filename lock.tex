...
and are explained in the RISC-V documentation~\cite{riscv:user}.
...
Yielding while holding a spinlock is illegal because it would violate
the property that interrupts must be off while a spinlock is held.
