...
address of the \indextext{interrupt handler} in
...
\item Interrupt in user mode. This case is challenging.  At the time
  ...
  \indextext{trampoline} page.  It maps a page with
...
Like programming the CLINT, programming the virtio disk uses memory-mapped
...
the \indextext{Platform Level Interrupt Controller (PLIC)} to
