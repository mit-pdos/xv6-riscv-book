...
situation is a system call, when a user program intentionally
executes an instruction indicating that it wishes the kernel to
perform a task for it. Another situation is an \indextext{exception}:
...
user space, and non-timer traps from kernel space.
