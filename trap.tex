...
registers (\lstinline{mtvec}\index{mtvec@\lstinline{mtvec}} and
\lstinline{stvec}\index{stvec@\lstinline{stvec}}) to specify the
...
(\lstinline{mip}\index{mip@\lstinline{mip}} and
\lstinline{sip}\index{sip@\lstinline{sip}}) to specify which
...
the time of interrupt in \lstinline{mepc}\index{mepc@\lstinline{mepc}}
or in \lstinline{sepc}\index{sepc@\lstinline{sepc}}, and saves the
...
\lstinline{mscratch}\index{mscratch@\lstinline{mscratch}} and
\lstinline{sscratch}\index{sscratch@\lstinline{sscratch}}.  The idea is
...
an instruction \lstinline{ecall}\index{ecall@\lstinline{ecall}}, which
...
\lstinline{scause}\index{scause@\lstinline{scause}}, which specifies
