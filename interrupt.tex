...
The console driver \fileref{console.c}
...
Interrupts complicate kernel programming because interrupts can be
delivered at any time and to any of the CPUs of a multi-core machine;
...
re-enabling them after line 3; xv6 provides \lstinline{intr_off} and
\lstinline{intr_on} for this purpose.  Chapter~\ref{CH:LOCK} explores how to
